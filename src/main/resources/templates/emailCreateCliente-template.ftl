                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#d3be6c"
                        ...
                        <div style="font-size: 48px; color:#010326;">
                            <b>Notificação Cadastro na DBCar</b>
                            <br>
                        </div>

                        <div style="font-size: 24px; color: #010326;">
                            <b>Olá, ${nome}</b>
                            <b>Muito obrigado por desejar fazer parte da DBCar. Seu cadastro foi realizado com sucesso. Seu código de identificação é ${id}.</b>
