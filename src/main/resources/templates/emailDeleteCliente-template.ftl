                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#d3be6c"
                        ...
                        <div style="font-size: 48px; color:#010326;">
                            <b>Notificação Cancelamento de Conta</b>
                            <br>
                        </div>

                        <div style="font-size: 24px; color: #010326;">
                            <b>Olá, ${nome}</b>
                            <b>Informamos que seus dados foram removidos do nosso banco de dados. Agradecemos por utilizar nossos serviços e caso deseje retornar, receberemos você de portas abertas.</b>
